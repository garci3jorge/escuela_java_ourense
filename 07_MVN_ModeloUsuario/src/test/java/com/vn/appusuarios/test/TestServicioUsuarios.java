...
public class TestServicioUsuarios {
    ...
    public void crearUsuariosValidos() {
        Usuario u1 = srvUsu.crear("a@a1.a", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("a@a1.a2", "1234", "Nom B", "30");
        Usuario u3 = srvUsu.crear("a@ee.a2", "e1234", "Nom C", "40");

        assertTrue(srvUsu.leerUno("a@a1.a").getId() > 0);
        assertEquals("Nom B", srvUsu.leerUno("a@a1.a2").getNombre());
    ...
    public void modificacionesInvalidasDeUsuarios() {
        Usuario u1 = srvUsu.crear("a@a1.aaa", "1234", "Nom A", "20");
        Usuario u2 = srvUsu.crear("a@a1.a2", "1234", "Nom B", "30");

        srvUsu.modificar(u1.getId(), "@dfdf", u1.getPassword(), u1.getNombre(), "25");
        assertEquals(20, srvUsu.leerUno("a@a1.aaa").getEdad());

        srvUsu.modificar(u2.getId(), "psdee.dd", u2.getPassword(), u2.getNombre(), "30");
        assertEquals("a@a1.a2", srvUsu.leerUno(u2.getId()).getEmail());
        srvUsu.eliminar(u1.getId());
        srvUsu.eliminar(u2.getId());
    }
    ...
    public void modificarUsuariosValidos() {
        ...
        assertEquals(25, srvUsu.leerUno("a@a1.a").getEdad());
    ...
    public void eliminarUsuarios() {
        ...
        assertNull(srvUsu.leerUno("a@a1.a"));
    ...
    public void listarTodos() {
        ...
        listaCreados.add(srvUsu.crear("a@a1.a", "1234", "Nom A", "20"));
        listaCreados.add(srvUsu.crear("a@a1.a2", "1234", "Nom B", "30"));
